...
<table width="560" border="0" cellpadding="0" cellspacing="0">
 ...
 <tr>
	...
	<?php 
	$nmc = mysql_query('SELECT COUNT(*) AS nmc FROM mi WHERE mid_e = "'.$userdata['user_id'].'"');
	$nmc = mysql_fetch_assoc($nmc);
	$nmc = $nmc['nmc'];
	?>
	<b> <center>Boite d'envoi </b><img src="/img/spacer.gif" height="15" width="50" /></center>
		...
		<div  style="overflow:auto;height:400px;">
		 <table width='100%' border='0' cellpadding="3" cellspacing="0">
                           <tr>
                             ...
                             <td valign="top" align="center" nowrap="nowrap"><b>A</b></td>
						   ...
						   if($nmc == 0)
						   {
								echo '<tr><td></td><td>Tu n\'as aucun message dans ta boite d\'envoi</td></tr>';
						   }
						   else
						   {
						   ?>
						  ...
						  <?php
						  $data_reception = mysql_query('SELECT * FROM mi WHERE mid_e = "'.$userdata['user_id'].'" ORDER BY id DESC');
						  $i = 0;
						  while($dr = mysql_fetch_assoc($data_reception))
						  {
							$de = mysql_query('SELECT username FROM phpbb_users WHERE user_id = "'.$dr['mid_r'].'"');
							...
							?>
                             ...
                             <td valign="top" align="center" nowrap="nowrap"><?php echo '<a href="/annuaire/?mid='.$dr['mid_r'].'">'.$de['username'].'</a>'; ?></td>
                             <td valign="top" width="1%" align="center" nowrap="nowrap"><?php echo '<a href="view_msg_e.php?id='.$dr['id'].'">'.stripslashes(coup($dr['sujet'], 30)).'</a>';?> </td>
