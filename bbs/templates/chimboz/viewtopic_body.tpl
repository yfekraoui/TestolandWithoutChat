...
<span style="color:#FFFFFF;">&raquo;</span>
<a href="{U_VIEW_FORUM}" class="forumlink" style="color:#FFFFFF;">{FORUM_NAME}</a>
<span style="color:#FFFFFF;">&raquo;</span><br />&nbsp;
<a href="{U_VIEW_TOPIC}" class="forumlink" style="color:#FFFFFF;font-size:20px;">{TOPIC_TITLE}</a>
</span></td></tr></table>
{POLL_DISPLAY}
{TPL_SLOT_BLUE_TOP}
<table class="forumline" width="100%" cellspacing="0" cellpadding="3" border="0"><tr>
<td style="padding:0;" colspan="2" height="25" valign="top" background="/img/index_body_thead.gif"><table class="forumline" width="100%" cellspacing="0" cellpadding="0" border="0">
...
<td align="center" width="50%">TEST</td>
<td align="right" width="25%">{PAGE_NEXT}</a></td>
</tr></table></td></tr><tr><td colspan="6">
<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
<td align="left" background="http://img.chapatiz.com/index_body_cat_sep.gif"><img src="http://img.chapatiz.com/index_body_cat_sep_l.gif"/></td>
<td align="right" background="http://img.chapatiz.com/index_body_cat_sep.gif"><img src="http://img.chapatiz.com/index_body_cat_sep_r.gif"/></td>
</tr></table></td></tr>
<!-- END need_several_pages -->
<!-- BEGIN postrow -->
{postrow.TR_SEPARATOR}
<tr><td width="150" align="center" valign="top" class="{postrow.ROW_CLASS}"><a name="{postrow.U_POST_ID}"></a>
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="100" height="95" id="bbsmemb" align="middle">
  ...
  <embed src="{postrow.FLASHURL}" quality="high" bgcolor="#ffffff" width="100" height="95" name="bbsmemb" align="middle" menu="false" allowscriptaccess="always" FlashVars="{postrow.FLASHVARS}" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /></embed>
</object>

<br />
<span class="name"><a href="/annuaire/?mid={postrow.POSTER_ID}"><b>{postrow.POSTER_NAME}</b></a></span><br />
<span class="nav">{postrow.POST_DATE}</span>{postrow.ONLINE}</td>
...
{postrow.DELETE_IMG}
{postrow.IP_IMG}
</td></tr><tr><td colspan="2"><img src="http://img.chapatiz.com/spacer.gif" width="2" height="4"/></td></tr>
<tr><td colspan="2" align="left" background="http://img.chapatiz.com/index_body_cat_sep.gif"><img src="http://img.chapatiz.com/index_body_cat_sep_l.gif"/></td></tr>
<tr><td colspan="2"><img src="http://img.chapatiz.com/spacer.gif" width="2" height="4"/></td></tr><tr><td colspan="2"><span class="postbody">
{postrow.MESSAGE}
<em style="color:#333333;">{postrow.SIGNATURE}</em></span><br /><img src="http://img.chapatiz.com/spacer.gif" width="600" height="1"></td></tr></table></td></tr>
<!-- END postrow -->
<tr><td colspan="6"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
<td align="left" background="http://img.chapatiz.com/index_body_cat_sep.gif"><img src="http://img.chapatiz.com/index_body_cat_sep_l.gif"/></td>
<td align="right" background="http://img.chapatiz.com/index_body_cat_sep.gif"><img src="http://img.chapatiz.com/index_body_cat_sep_r.gif"/></td></tr></table></td></tr>
<tr><td colspan="6"><table width="100%"  border="0" cellspacing="3" cellpadding="3"><tr>
<td align="left" width="25%">{PAGE_PREVIOUS}</td>
...
<td class="gensmall">{S_SELECT_POST_ORDER}><br /><span class="nav">{PAGINATION}</span></td>
<td class="gensmall"><input type="image" border="0" name="submit" src="http://img.chapatiz.com/go.gif" value="{L_GO}" width="27" height="18"></td>
