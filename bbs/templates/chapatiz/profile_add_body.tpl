...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
		<th class="thHead" nowrap="nowrap"  background="templates/chimboz/images/index_body_thead.gif" colspan="2" height="25" valign="middle">{L_REGISTRATION_INFO}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th class="thSides" colspan="2" height="12" valign="middle">Avatar</th>
	</tr>
	<tr> 
	  <td class="row1" colspan="2"><input type="text" class="post" style="width: 200px"  name="avatar_design" size="35" maxlength="150" value="n;1;1;1" />
	  </td>
	</tr>
