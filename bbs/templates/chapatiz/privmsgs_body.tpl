...
<form method="post" name="privmsg_list" action="{S_PRIVMSGS_ACTION}">
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	<tr> 
	  <th width="5%" height="25" class="thCornerL" nowrap="nowrap" background="templates/chimboz/images/index_body_thead.gif">&nbsp;{L_FLAG}&nbsp;</th>
	  <th width="55%" class="thTop" nowrap="nowrap" background="templates/chimboz/images/index_body_thead.gif">&nbsp;{L_SUBJECT}&nbsp;</th>
	  <th width="20%" class="thTop" nowrap="nowrap" background="templates/chimboz/images/index_body_thead.gif">&nbsp;{L_FROM_OR_TO}&nbsp;</th>
	  <th width="15%" class="thTop" nowrap="nowrap" background="templates/chimboz/images/index_body_thead.gif">&nbsp;{L_DATE}&nbsp;</th>
	  <th width="5%" class="thCornerR" nowrap="nowrap" background="templates/chimboz/images/index_body_thead.gif">&nbsp;{L_MARK}&nbsp;</th>
	</tr>
	<!-- BEGIN listrow -->
	<tr> 
