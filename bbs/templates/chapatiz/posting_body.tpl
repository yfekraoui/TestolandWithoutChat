...
hs_help = "Hors-sujet: [hs]texte[/hs] (alt+h)";
r_help = "Texte rayé: [s]texte[/s] (alt+r)";
document.L_EMPTY_MESSAGE = "{L_EMPTY_MESSAGE}";
//-->
</script>
	  ...
	  <td class="row2" valign="top"><span class="gen"> <span class="genmed"> </span> 
		<table width="450" border="0" cellspacing="0" cellpadding="2">
		  <tr align="center" valign="middle">
						...
						<td><span class="genmed">
						  <input type="button" class="bouton" accesskey="h" name="addbbcode24" value="Hors-sujet" style="" onClick="bbstyle(24)" onMouseOver="helpline('hs')" />
						  </span></td>
		  </tr>
		  <tr> 
			<td colspan="9"> 
