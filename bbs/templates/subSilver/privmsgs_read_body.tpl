...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
	<tr bgcolor="#FFFFFF" background="../bbs/templates/chimboz/images/index_body_thead.gif"> 
	  <td colspan="3" nowrap="nowrap" class="thHead">{BOX_NAME} :: {L_MESSAGE}</td>
	</tr>
	<tr> 
	...
	<tr> 
	  <td class="row2"><span class="genmed">{L_AVATAR}:</span></td>
	  <td width="100%" class="row2" colspan="2"><span class="genmed">{L_AVATAR}</span></td>
	</tr>
	<tr> 
	...
	<tr>
	  <td class="catBottom" colspan="3" height="28" align="right"> {S_HIDDEN_FIELDS} 
		...
		&nbsp; 
		<input type="submit" name="delete" value="{L_DELETE_MSG}" class="liteoption" />	  </td>
	</tr>
  </table>
    <!-- end content -->
	</td>
...
<table width="100%" cellspacing="0" border="0" cellpadding="0">
  <tr>
	<td width="3" background="templates/chimboz/images/index_body_left.gif"><img src="templates/chimboz/images/spacer.gif" width="3" height="3"/></td>
	<td bgcolor="#FFFFFF"><table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
  <tr> 
