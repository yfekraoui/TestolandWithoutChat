...
<table width="100%" cellspacing="0" cellpadding="2" border="0" align="center">
  <tr>
	<td align="left" valign="bottom">
		<span><a href="{U_INDEX}" class="forumlink" style="color:#ff0099;">BBS</a></span>
	</td>
...
<table width="100%" cellpadding="2" cellspacing="0" border="0" class="forumline" bgcolor="FFFFFF">
  ...
  <tr>
	...
	<td class="row1" width="100%" height="50"><span class="forumlink"><a href="{catrow.forumrow.U_VIEWFORUM}" class="forumlink" style="color:#ff0099;">{catrow.forumrow.FORUM_NAME}</a><br />
