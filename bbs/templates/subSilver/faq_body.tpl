...
<table width="100%" cellspacing="0" border="0" cellpadding="0">
  <tr>
	...
	<td bgcolor="#FFFFFF">
<table class="forumline" width="100%" cellspacing="0" cellpadding="4" border="0" align="center">
	<tr>
		<th class="thHead" valign="top" height="25" background="http://img.chapatiz.com/index_body_thead.gif">{L_FAQ_TITLE}</th>
	</tr>
	<tr>
		<td class="row1">
...
<table class="forumline" width="100%" cellspacing="0" cellpadding="4" border="0" align="center">
	<tr> 
		<td class="catHead" height="28" align="center" background="http://img.chapatiz.com/index_body_cat_tile.gif"><span class="cattitle">{faq_block.BLOCK_TITLE}</span></td>
	</tr>
	<!-- BEGIN faq_row -->  
	<tr> 
...
<table width="100%" cellspacing="2" border="0" align="center">
	<tr>
		<td align="center" valign="middle" nowrap="nowrap">{JUMPBOX}</td>
	</tr>
</table>
<!-- end content -->
	</td>
