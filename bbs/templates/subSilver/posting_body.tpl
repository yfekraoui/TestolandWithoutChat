	  ...
	  <td class="row2" valign="top"><span class="gen"> <span class="genmed"> </span> 
		<table width="450" border="0" cellspacing="0" cellpadding="2">
		  <tr align="center" valign="middle">
						...
						<td><span class="genmed">
						  <input type="button" class="bouton" accesskey="HS" name="addbbcode15" value="Hors-sujet" style="" onClick="bbstyle(24)" onMouseOver="helpline('HS')" id="addbbcode15" />
						  </span></td>
		  </tr>
		  <tr> 
			<td colspan="9"> 
