...
else if($userdata['user_level'] == "1" OR $userdata['modopro'] == "1")
{
	...
	if($donnees['exist'] != 0)
	{
		...
		echo 'Les modifications ont été enregistrées, cliquez <a href="/mp/">ici</a> pour retourner au menu de l\'administration :) !<br /><br />Membre modifié : <a href="/annuaire/?mid='.$idid.'">'.$pseudo.'</a>';
	}
	else
	{
