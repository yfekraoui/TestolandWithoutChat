...
echo 'Ajouter un membre au groupe :<form action="grupok.php" method="GET"> <input  type="texte" name="pseudo_ad_k" maxlength="100" value="Un pseudo"><br /><input type="submit" value="Envoyer"></form><br />';
echo 'Supprimer un membre du groupe : <form action="grupok.php" method="GET"> <input  type="texte" name="pseudo_del_k" maxlength="100" value="Un pseudo"><br /><input type="submit" value="Envoyer"></form><br /><br />';
echo $espacer;
echo'<b>Borgne : </b><br /><br />';
echo 'Ajouter un membre au groupe : <form action="grupok.php" method="GET"> <input  type="texte" name="pseudo_ad_b" maxlength="100" value="Un pseudo"><br /><input type="submit" value="Envoyer"></form><br />';
echo 'Supprimer un membre du groupe : <form action="grupok.php" method="GET"> <input  type="texte" name="pseudo_del_b" maxlength="100" value="Un pseudo"><br /><input type="submit" value="Envoyer"></form><br /><br />';
echo $espacer;
