...
?>
<form method="post" action="pnok.php">
<b>Donner des Points Noel :</b> <br /><br />
Id du membre : <input type="text" name="id" size="3" /><br />
Don de points noel : <input type="text" name="don" /><br />
...
<td align="center" valign="top" ><b><?php echo $data['don_some'].'PN'; ?></b></td>
