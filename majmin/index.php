...
if(isset($_GET['pseudo']))
					  {	
							$npseudo = mysql_real_escape_string(htmlspecialchars($_GET['pseudo']));
 ...
 ?>
                        ...
                        Tu peux changer uniquement le MajMiN des lettres, tu ne peux pas en rajouter, tu ne peux pas en enlever, tu ne peux pas &eacute;changer une lettre par une autre. <br> 
							...
							<br /> 
							<br /> 
							<b><?php if($m == true){ echo $pseudo;} else { echo $userdata['username'];} ?></b> <br /> 
					  ...
					  <br /> 
					  <b>
					  <input name="pseudo" type="text" value="<?php if($m == true){ echo $pseudo;} else { echo $userdata['username'];} ?>" size="25" />
					  </b>			  <br /> 
					  <br /> 
					  <input type="submit" value="Aller ! Change mon MajMiN !" />                   								
					  </form> 
						<?php
						}
						?>
