...
else if($userdata['user_level'] == "1")
{
	...
	<?php
	$i = 0;
	$sql = mysql_query("SELECT id, name, prix, name_bd, type FROM shopping");
	while($data = mysql_fetch_assoc($sql))
	{
		...
		if($type == "pack")
		{
			echo '<a href="/admin/shopview.php?id='.$id.'"><img src="/shopping/img/'.$name_bd.'.jpg"></a>';
		}
...
<b><br /><br /><br /><a href="/admin/addshop.php"><font style="color:rgb(255,47,151);">• </font>Ajouter un pack !</a></b></center><br />
	</center>
	<?php
