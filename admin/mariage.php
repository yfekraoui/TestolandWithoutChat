...
else if($userdata['user_level'] == "1")
{
	...
	<p><b>Faire un mariage  : </b><br />
	<b><font style="color:rgb(255,47,151);">•••••••••••••••••••••••••••••••••••••••••••••••••<br></font></b><br /></p>
	<form method="post" action="mariageok.php">
	<b>Mariage :</b> <br /><br />
	<label for="id_1">ID : </label><input type="text" name="id_1" size="5" id="id_1" />
	<label for="username_1">Pseudo : </label><input type="text" name="username_1" size="20" id="username_1" /><br /><br />
	<b>AVEC</b><br /><br />
	<label for="id_2">ID : </label><input type="text" name="id_2" size="5" id="id_2" />
	<label for="username_2">Pseudo : </label><input type="text" name="username_2" size="20" id="username_2" /><br /><br />
	<input type="submit" value="Marier !" />
	</form><br /><br />
	( il faut indiquer le numero du membre(dans l'ID) et son pseudo ).
	</center>
	<?php
